...
good practice to make your **plugin's main class** (this is what you call the class that extends `JavaPlugin`) `final` to avoid any intended or unintended extending.
