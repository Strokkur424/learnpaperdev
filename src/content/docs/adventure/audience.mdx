...
- <JavaDocs id="Audience" method="sendMessage" params="Component">sendMessage(ComponentLike)</JavaDocs>
...
### Constructing a <JavaDocs id="Sound">Sound</JavaDocs>, <JavaDocs id="Title">Title</JavaDocs>, <JavaDocs id="BossBar">BossBar</JavaDocs>, and <JavaDocs id="AdventureBook">Book</JavaDocs>
